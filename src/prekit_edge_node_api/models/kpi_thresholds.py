...
class KpiThresholds(BaseModel):
    ...
    KpiThresholds
    """ # noqa: E501
    mode: StrictStr = Field(description="\"above\" = higher is better, \"below\" = lower is better.")
    success: StrictFloat | StrictInt | None
    warning: StrictFloat | StrictInt | None
    __properties: ClassVar[list[str]] = ["mode", "success", "warning"]
