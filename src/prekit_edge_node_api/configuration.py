...
conf = prekit_edge_node_api.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("prekit_edge_node_api")
